...
// Function to create a maze object given a width and height (in squares)
...
// Function to make a "creative" maze that is not strictly square or rectangular.
// This function creates a triangular maze.
...
// This function sets the status of the wall given its position and direction.
...
// This function is used by the solveMaze function to determine if it is possible
// to travel in the specified direction from a specific square.
...
// This function uses a DFS algorithm to solve the maze. 
...
// This function is a helper to solve the maze. It is a recursive function
// that has been transformed into an iterative version using a queue to
// store data that is passed between recursive calls.
...
// This function uses the provided cs225::PNG class to draw
// the maze. Each square is a 10x10 pixels large.
// The maze is drawn with an entrance in the top left corner,
// but it does not have an exit. The exit is drawn in the
// drawMazeWithSolution function and is placed in the bottom
// row in the furthest square from the entrance.
...
// This function is the same as the previous except it now draws
// a red path that leads to the exit. 
...
// This function draws a "creative" maze.
